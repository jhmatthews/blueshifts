...
for f in fnames:
		...
		print (rho2nh)
		ne = rho * rho2nh
		mappable = plt.scatter(np.log10(ne), np.log10(vz/1e5), c=np.log10(lc4), s=5, vmin=37.5, vmax=42.5, cmap=cmap)
...
plt.subplots_adjust(top=0.96, left=0.06, bottom=0.14, right=0.98, wspace=0.05, hspace=0.05)
