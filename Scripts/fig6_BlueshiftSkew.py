...
def make_figure():
	...
	blueshifts, skew = np.genfromtxt("{}/blueshifts_skews_composites.dat".format(data_dir), unpack=True)
	#blueshifts, ews, skew, vpeak = blueshift_util.measure_blueshifts()
	plt.scatter(blueshifts, skew, c="k", zorder=3, marker="x", label="Composites")
